 ...
 */
public class JceAesCbcCryptoCodec extends AesCbcCryptoCodec {
  private static final Log LOG =
      LogFactory.getLog(JceAesCbcCryptoCodec.class.getName());

  private String provider;
  private SecureRandom random;

  public JceAesCbcCryptoCodec(Properties props) {
  ...
  public Encryptor createEncryptor() throws GeneralSecurityException {
    return new JceAesCbcCipher(Cipher.ENCRYPT_MODE, provider);
  }

  @Override
  public Decryptor createDecryptor() throws GeneralSecurityException {
    return new JceAesCbcCipher(Cipher.DECRYPT_MODE, provider);
  }
  ...
  private static class JceAesCbcCipher implements Encryptor, Decryptor {
    private final Cipher cipher;
    private final int mode;
    private boolean contextReset = false;

    public JceAesCbcCipher(int mode, String provider)
